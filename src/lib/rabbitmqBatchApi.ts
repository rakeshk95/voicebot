...
export class RabbitMQBatchApiService {
   ...
   */
  static async getRabbitMQOperationStatus(bulkOperationId: string): Promise<any> {
    const response = await fetch(
      `${BACKGROUND_SERVER_URL}/operations/${bulkOperationId}/status`,
      { headers: getAuthHeaders() }
    );
    await handleApiError(response);
    return response.json();
   ...
   */
  static async getAllRabbitMQOperations(): Promise<any> {
    const response = await fetch(
      `${BACKGROUND_SERVER_URL}/operations`,
      { headers: getAuthHeaders() }
    );
    await handleApiError(response);
    return response.json();
   ...
   */
  static async pauseRabbitMQOperation(bulkOperationId: string): Promise<any> {
    const response = await fetch(
      `${BACKGROUND_SERVER_URL}/operations/${bulkOperationId}/pause`,
      {
        method: 'POST',
        headers: getAuthHeaders()
      }
   ...
   */
  static async resumeRabbitMQOperation(bulkOperationId: string): Promise<any> {
    const response = await fetch(
      `${BACKGROUND_SERVER_URL}/operations/${bulkOperationId}/resume`,
      {
        method: 'POST',
        headers: getAuthHeaders()
      }
   ...
   */
  static async deleteRabbitMQOperation(bulkOperationId: string): Promise<any> {
    const response = await fetch(
      `${BACKGROUND_SERVER_URL}/operations/${bulkOperationId}`,
      {
        method: 'DELETE',
        headers: getAuthHeaders()
      }
