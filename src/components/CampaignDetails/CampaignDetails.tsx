                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input {...field} disabled className="h-9 bg-gray-50" />
                        </FormControl>
                      </FormItem>
                    )}
                  />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <Input value={field.value} disabled className="h-9 bg-gray-50" />
                      </FormItem>
                    )}
                  />
                </div>
                      ...
                      <FormItem>
                        ...
                        <div className="relative">
                          <Textarea
                            ...
                            className="min-h-[200px] bg-gray-50 w-full"
                            disabled
                            readOnly
                          />
                          ...
                          Object.entries(campaign.llm.promptJson.promptVariables).length > 0 ? (
                            Object.entries(campaign.llm.promptJson.promptVariables).map(([key, value], index) => (
                              <div key={index} className="grid grid-cols-2 gap-4">
                                <Input value={key} disabled className="bg-gray-50" readOnly />
                                <Input 
                      ...
                      {campaign.post_call_actions?.categories && 
                        Object.entries(campaign.post_call_actions.categories).map(([key, value], index) => (
                          <div key={index} className="grid grid-cols-2 gap-4">
                            ...
                            <Input value={value as string} disabled className="bg-gray-50" />
                          </div>
                        ))
                      }
                    </div>
