    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4">
        {Object.entries(operations.operations).map(([operationId, operation]) => {
          ...
          const progressPercentage = operation.total_calls > 0 
            ? (operation.completed_calls / operation.total_calls) * 100 
            : 0;
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-medium">
                      {operation.completed_calls} / {operation.total_calls} calls
                    </span>
                  </div>
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  ...
                  <div className="space-y-1">
                    <div className="text-2xl font-bold text-orange-600">
                      {operation.total_calls - operation.completed_calls}
                    </div>
