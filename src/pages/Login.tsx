...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('http://192.168.29.119:8000/api/v1/auth/login', {
        method: 'POST',
        headers: {
      ...
      try {
        ...
        const permissionsResponse = await fetch(`http://192.168.29.119:8000/api/v1/roles/user/${userId}`, {
          headers: {
